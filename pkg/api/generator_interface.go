...
func GenerateInterfaceCode(interfaceType *types.Interface, interfaceObject types.Object, implementations []*types.TypeName, jsonTypeTagName string) string {
	...
	file.Comment("// Code generated by github.com/pschichtel/auto-marshal! DO NOT EDIT.")
